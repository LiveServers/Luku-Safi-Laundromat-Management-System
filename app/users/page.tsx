          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 gap-4">
            <div className="flex items-center min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-2xl font-bold text-gray-900 truncate">User Management</h1>
                <p className="text-sm sm:text-base text-gray-600 hidden sm:block">Manage system users and their roles</p>
              </div>
            </div>
